...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 2009-YYYY The Bitcoin and Auroracoin Core developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Smileycoin Core", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Smileycoin Core</b> version", Q_NULLPTR));
