...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        dataLabel = new QLabel(SendCoins);
        ...
        addData = new QLineEdit(SendCoins);
        addData->setObjectName(QStringLiteral("addData"));

        gridLayout->addWidget(addData, 2, 1, 1, 1);
        ...
        gridLayout->addWidget(payAmount, 3, 1, 1, 1);
        ...
        gridLayout->addWidget(messageTextLabel, 4, 1, 1, 1);
        ...
        QWidget::setTabOrder(addAsLabel, addData);
        QWidget::setTabOrder(addData, payAmount);
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. DNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        dataLabel->setText(QApplication::translate("SendCoinsEntry", "&Data:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        addData->setToolTip(QApplication::translate("SendCoinsEntry", "Enter a message to send with this transfer", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the smileycoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Smileycoin network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
