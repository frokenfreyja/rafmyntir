...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to Smileycoin Core.", Q_NULLPTR));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where Smileycoin Core will store its data.", Q_NULLPTR));
        sizeWarningLabel->setText(QApplication::translate("Intro", "Smileycoin Core will download and store a copy of the Smileycoin block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", Q_NULLPTR));
