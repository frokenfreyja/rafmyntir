...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        frame->setStyleSheet(QStringLiteral("#frame{border:none; background:#ffffff;}"));
        ...
        labelBalance->setText(QStringLiteral("0 SMLY"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 SMLY"));
        ...
        labelImmature->setText(QStringLiteral("0 SMLY"));
        ...
        frame_2->setStyleSheet(QStringLiteral("#frame_2{border:none; background:#ffffff;}"));
        ...
        labelTransactionsStatus->setFont(font);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Smileycoin network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Smileycoin network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
