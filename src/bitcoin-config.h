...
#define PACKAGE_BUGREPORT "smlyarad@smlyarad.is"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Smileycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Smileycoin Core 2.2.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "smileycoin"
